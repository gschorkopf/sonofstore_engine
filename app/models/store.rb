class Store < ActiveRecord::Base
  ...
  validate :unique_name_among_approved_stores, on: :create
  validate :unique_name_among_approved_stores, on: :update
  validate :unique_path_among_approved_stores, on: :create
  validate :unique_name_among_approved_stores, on: :update
